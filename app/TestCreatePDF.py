...
pdf.drawingToPDF(lga_bar_chart, 'tests/test_lgabc.pdf')

taxons_bar_chart = pdf.getTaxonsBarChart('01', 2018)
pdf.drawingToPDF(taxons_bar_chart, 'tests/test_taxonsbc.pdf')

pdf.getMonthlyReport('tests/test_monthlyreport.pdf', '01', 2018)
