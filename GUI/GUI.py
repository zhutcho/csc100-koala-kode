...
# b7bbc3
        ...
        username_label = tk.Label(
            login_frame, text="Username: ", bg='#7f8694', fg='#1b1811', font="Helvetica 10")
        ...
        password_label = tk.Label(
            login_frame, text="Password: ", bg='#7f8694', fg='#1b1811', font="Helvetica 10")
        password_label.place(relx=0.045, rely=0.38, anchor=tk.W)
        # Entry Box
        ...
        login_button = tk.Button(
            login_frame, text="Login", command=lambda: reg.Registry.login_entry(self))
